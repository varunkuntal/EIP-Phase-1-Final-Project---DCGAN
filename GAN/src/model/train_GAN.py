...
# Utils
sys.path.append("/content/DeepLearningImplementations/GAN/src/utils")
...
def train(**kwargs):
    ...
    try:
        ...
        for e in range(nb_epoch):
            ...
            if e % 5 == 0:
                gen_weights_path = os.path.join('/content/DeepLearningImplementations/GAN/models/%s/gen_weights_epoch%s.h5' % (model_name, e))
                generator_model.save_weights(gen_weights_path, overwrite=True)

                disc_weights_path = os.path.join('/content/DeepLearningImplementations/GAN/models/%s/disc_weights_epoch%s.h5' % (model_name, e))
                discriminator_model.save_weights(disc_weights_path, overwrite=True)

                DCGAN_weights_path = os.path.join('/content/DeepLearningImplementations/GAN/models/%s/DCGAN_weights_epoch%s.h5' % (model_name, e))
